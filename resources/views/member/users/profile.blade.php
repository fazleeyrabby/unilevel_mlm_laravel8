...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form class="" action="{{ url('member/users/'.base64_encode($user->id * Auth::user()->id).'/update-contact')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="national_id" name="national_id" type="text" class="form-control @error('national_id') parsley-error @enderror"  @if($user->id !== Auth::user()->id) {{ 'disabled'}} @endif  required placeholder="national_id" value="{{$user->national_id}}">
                        <ul class="parsley-errors-list filled">
                            @error('national_id')
                            <li class="parsley-required">{{$message}}</li>
                            @enderror
    ...
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form class="" action="{{ url('member/users/'.base64_encode($user->id * Auth::user()->id).'/update-password')}}" method="post" novalidate="">
                    @csrf
                    <div class="form-group">
                        <label for="username">Username</label>
    ...
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form class="" action="{{ url('member/users/'.base64_encode($user->id * Auth::user()->id).'/update-trans-pass')}}" method="post" novalidate="">
                    @csrf
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input id="username" type="text" class="form-control" required disabled value="{{$user->username}}" placeholder="{{$user->username}}">
