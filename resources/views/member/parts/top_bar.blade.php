        ...
        <ul class="list-inline float-right mb-0">
            <li class="list-inline-item notification-list dropdown d-none d-sm-inline-block">
                <form role="search" class="app-search">
                    <div class="form-group mb-0"> 
                        <a href="{{ url('member/users/join') }}" class="btn btn-success rounded-pill">New member registration</a>
                    </div>
                </form> 
            </li>
            ...
            <li class="list-inline-item dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
                    <a class="dropdown-item" href="{{url('member/users/'.base64_encode(Auth::user()->id * Auth::user()->id).'/profile')}}"><i class="mdi mdi-account-circle m-r-5 text-muted"></i> Profile</a>
