...
<div class="row">
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form class="" action="{{ url('admin/users/join')}}" method="post" novalidate=""  enctype="multipart/form-data">
                    @csrf
		...
		<div class="card m-b-30">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input id="profile_picture" name="profile_picture" type="file" class="form-control @error('profile_picture') parsley-error @enderror" required placeholder="profile picture">
					<ul class="parsley-errors-list filled">
		...
		<div class="card m-b-30">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<input id="new_password" name="password" type="password" class="form-control @error('password') parsley-error @enderror" required >
					<ul class="parsley-errors-list filled">
						@error('password')
						<li class="parsley-required">{{$message}}</li>
						@enderror
				...
				<div class="form-group">
					...
					<input id="confirm_password" name="Confirm Password" type="password" class="form-control @error('confirm_password') parsley-error @enderror" required >
					<ul class="parsley-errors-list filled">
