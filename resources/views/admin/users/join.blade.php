...
<div class="row">
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form class="" action="{{ url('admin/users/join')}}" method="post" novalidate="">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('position') parsley-error @enderror" id="position" name="position" value="{{old('position')}}" >
                            ...
                            <option {{ old('position') == 1 ? "selected" : "" }} value="1">1</option>
                            <option {{ old('position') == 2 ? "selected" : "" }} value="2">2</option>
                            <option {{ old('position') == 3 ? "selected" : "" }} value="3">3</option>
                            <option {{ old('position') == 4 ? "selected" : "" }} value="4">4</option>
                            <option {{ old('position') == 5 ? "selected" : "" }} value="5">5</option>
                            <option {{ old('position') == 6 ? "selected" : "" }} value="6">6</option>
                            <option {{ old('position') == 7 ? "selected" : "" }} value="7">7</option>
                            <option {{ old('position') == 8 ? "selected" : "" }} value="8">8</option>
                            <option {{ old('position') == 9 ? "selected" : "" }} value="9">9</option>
                            <option {{ old('position') == 10 ? "selected" : "" }} value="10">10</option>
                        </select>
                        <ul class="parsley-errors-list filled">
                        @error('position')
                            <li class="parsley-required">{{$message}}</li>
        ...
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input id="new_password" name="password" type="text" class="form-control @error('password') parsley-error @enderror" required placeholder="new_password" value="{{old('sponsor_id')}}">
                    <ul class="parsley-errors-list filled">
                        @error('password')
                            <li class="parsley-required">{{$message}}</li>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <input id="confirm_password" name="confirm_password" type="text" class="form-control @error('confirm_password') parsley-error @enderror" required placeholder="confirm_password" value="{{old('dealer_code')}}">
                    <ul class="parsley-errors-list filled">
        ...
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input id="new_password" name="transaction_password" type="text" class="form-control @error('transaction_password') parsley-error @enderror" required placeholder="new_password" value="{{old('sponsor_id')}}">
                    <ul class="parsley-errors-list filled">
                ...
                <div class="form-group">
                    ...
                    <input id="confirm_password" name="confirm_transaction_password" type="text" class="form-control @error('confirm_transaction_password') parsley-error @enderror" required placeholder="confirm_password" value="{{old('dealer_code')}}">
                    <ul class="parsley-errors-list filled">
