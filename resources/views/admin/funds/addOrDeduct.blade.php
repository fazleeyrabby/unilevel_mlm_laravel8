...
<div class="row">
    <div class="col-lg-6">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Direct fund </h4>
                <p class="text-muted m-b-30 font-14">You can add/deduct fund to any users from admin account, without any warning or permission.
                </p>
                <form action="" novalidate="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="username" value="{{old('username')}}" class="form-control @error('username') parsley-error @enderror" required="" data-parsley-minlength="6" placeholder="Min 6 chars." data-parsley-id="29">
                    ...
                    <div class="form-group">
                        <label>Amount</label>
                        <div>
                            <input type="text" name="amount" value="{{old('amount')}}" class="form-control @error('amount') parsley-error @enderror" required="" data-parsley-maxlength="6" placeholder="Max 6 chars." data-parsley-id="31">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input name="notes" type="text" value="{{old('notes')}}" class="form-control @error('notes') parsley-error @enderror"  placeholder="Text between 5 - 10 chars length" >
