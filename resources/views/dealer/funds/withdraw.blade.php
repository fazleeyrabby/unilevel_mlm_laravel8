               ...
               <!--  <p class="text-muted m-b-30 font-14">Parsley is a javascript form validation
                ...
                <form action="" novalidate="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="receiver" value="{{old('receiver')}}" class="form-control @error('receiver') parsley-error @enderror" class="form-control parsley-error" required="" data-parsley-minlength="6" placeholder="Admin only" data-parsley-id="29">
