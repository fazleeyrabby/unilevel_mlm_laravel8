...
<div class="row">
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form class="" action="{{ url('/dealer/users/join')}}" method="post" novalidate=""  enctype="multipart/form-data">
                    @csrf
        ...
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input id="new_password" name="password" type="password" class="form-control @error('password') parsley-error @enderror" required placeholder="new_password">
                    <ul class="parsley-errors-list filled">
                        @error('password')
                            <li class="parsley-required">{{$message}}</li>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <input id="confirm_password" name="confirm_password" type="password" class="form-control @error('confirm_password') parsley-error @enderror" required placeholder="confirm_password">
                    <ul class="parsley-errors-list filled">
        ...
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input id="new_password" name="transaction_password" type="password" class="form-control @error('transaction_password') parsley-error @enderror" required placeholder="Transaction password">
                    <ul class="parsley-errors-list filled">
                ...
                <div class="form-group">
                    ...
                    <input id="confirm_password" name="confirm_transaction_password" type="password" class="form-control @error('confirm_transaction_password') parsley-error @enderror" required placeholder="Confirm Transaction password">
                    <ul class="parsley-errors-list filled">
