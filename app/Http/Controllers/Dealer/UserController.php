...
class UserController extends Controller
{
    public function index()
    {
        ...
        return view('dealer.users', compact('users'));
    }
    ...
    {   
        ...
        return view('dealer.users.profile', compact('user','parent','sponsor','dealer'));
    }
    ...
    {   
        ...
        return view('dealer.users.referral', compact('user','users'));
    }
    ...
    {   
        ...
        return view('dealer.users.bonus', compact('user','bonus'));
    }
    ...
    public function contact_update(Request $request, $id)
    {
        ...
        if($user->save()){
            ...
            return redirect('dealer/users')->with(['status' => 'error', 'message' => 'Something went wrong!']);
        }
    }
    ...
    public function join()
    {
        ...
        return view('dealer.users.join', compact('packages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dealer/users/'.base64_encode($user_id).'/profile')>with(['status' => 'success', 'message' => 'User registration success!']);
    }
