    ...
    public function index(){
        ...
        for($i = 1; $i<=10; $i++){
            if(in_array($i, $pos)){
                ...
                <div class="single-genealogy">
                    <div class="single-genealogy-front">
                        ...
                        <h4><a href="'.url('dealer/genealogy-tree/'.base64_encode($data[$i]->id * Auth::user()->id)).'">'.$data[$i]->name.'</a></h4>  
                    </div>
            ...
            <div class="single-genealogy">
                <div class="single-genealogy-front">
                <img src="'.asset('assets/orgchart/img/user-level.png') .'" alt="User">
                    <h4><a href="'.url('dealer/users/join?p='.$i).'">  Add new</a></h4>
                </div>
            </div>
        </li>';
        }
    }
        return view('dealer/genealogy',compact('genealogies','liHTML','root'));
    }
